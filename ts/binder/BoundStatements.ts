...
//     return new DeclarationStmt(name, mutability, value as SyntaxExpression, type as HexType)
// }
...
//     } else return []
// }
// function searchExprSymbols(expr: SyntaxExpression): {name: string, type: HexType}[] {
